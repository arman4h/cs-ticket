...
export default function Dashboard({ selected, solved, onSelection, onResolved }) {
  ...
  const [activeSections, setActives] = useState("tickets") ;
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-3 max-w-7xl mx-auto py-5 pb-10">
        ...
        <div
          className={`col-span-1 md:col-span-3 ${activeSections === "tracks" ? "hidden" : "block"} md:block`}
        >
        ...
        <div
          className={`col-span-1 w-full justify-start ${activeSections === "tickets" ? "hidden" : "flex"} md:flex flex-col`}
        >
      ...
      <div className="dock md:hidden">
        <button
          className={`${activeSections === "tickets" ? "dock-active" : ""}`}
          onClick={() => setActives("tickets")}
        >
          <svg
        ...
        <button
          className={`${activeSections === "tracks" ? "dock-active" : ""}`}
          onClick={() => setActives("tracks")}
        >
          <svg
            className="size-[1.2em]"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="dock-label">Tracks</span>
        </button>
      </div>
      <ToastContainer />
    </div>
